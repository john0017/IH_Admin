...
browser = webdriver.Chrome("/Users/jithinjohn/Desktop/Scripts/In progress/Review_web/chromedriver", options=options)
...
def main_review():
    with open("/Users/jithinjohn/Desktop/Scripts/In progress/Review_web/id_map.json") as f:
        dict_ = json.load(f)
...
def test():
    return render_template('test1.html', missing_values=missing_values)
